...
export const getPendingListings = (params) =>
  client.get("/admin/listings", { params });
export const approveListing = (id) =>
  client.patch(`/admin/listings/${id}/approve`);
export const removeListing = (id, data) =>
  client.patch(`/admin/listings/${id}/remove`, data);
export const deleteListing = (id) => client.delete(`/admin/listings/${id}`);
export const getReports = (params) => client.get("/admin/reports", { params });
export const reviewReport = (id, data) =>
  client.patch(`/admin/reports/${id}`, data);
